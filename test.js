...
test("exclude2", makeTest("test", {exclude: ["**/subdir2"]}, [
  {path: join("test/file"), directory: false, symlink: false},
  {path: join("test/subdir"), directory: true, symlink: false},
  {path: join("test/subdir/file"), directory: false, symlink: false},
]));

test("exclude3", makeTest("test", {exclude: ["**/sub*"]}, [
  {path: join("test/file"), directory: false, symlink: false},
]));

test("exclude4", makeTest("test", {exclude: ["**/subdir", "**/subdir2"]}, [
  {path: join("test/file"), directory: false, symlink: false},
]));

test("exclude5", makeTest("test", {exclude: ["**"]}, []));
...
test("notfound", makeTest("notfound", undefined, results => {
